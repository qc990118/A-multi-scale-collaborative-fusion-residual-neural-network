...
from datasave1 import train_loader, test_loader
...
# optimizer = AdamP(model.parameters(), weight_decay=0.001, lr=0.0001, betas=(0.9, 0.999), nesterov=True, amsgrad=True)
...
torch.save(model.state_dict(), 'weight/JNU.pt')
...
class_names = ['0', '1', '2', '3']  # Replace with your actual class labels
...
colors = ['#e38c7a', '#656667', '#99a4bc', 'cyan']
markers = ['o', 's', '^', 's']
sizes = [80, 80, 80, 80]
...
roc_auc = {}
n_classes = 4
class_names = ['Normal','Ball-Fault', 'Inner-Fault','Outer-Fault',]
