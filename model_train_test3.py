...
# plot_confusion_matrix(cm, classes=class_names, normalize=True)
plot_confusion_matrix(cm, classes=class_names, normalize=False)
plt.savefig('weight/RNNWDCNN-1.tiff', format='tiff')
plt.show()
...
plt.savefig('weight/RNNWDCNN-tsne.wmf', format='wmf')
...
# Show the plot
plt.show()
plt.savefig('weight/RNNWDCNN-roc.tiff', format='tiff')