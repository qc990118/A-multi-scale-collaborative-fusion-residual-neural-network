...
from model import MCFRNNNGSM, MCFRNNNMRM, MCFRNNNSDM, MCFRNNSET
...
#             break
#     if layer is None:
#         raise ValueError('Layer not found: ' + layer_nwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwame)
